"""
Script name: rpd4_fill_payor_income_level.py

Description:
This script assigns the payor income level for each payor country in the RPD, using data from the dataset “Countries and Economies Data.xlsx”.
...
main_country_col = find_column_index(ws_main, "Payor country or economy")
main_income_col = find_column_index(ws_main, "Payor income level")
