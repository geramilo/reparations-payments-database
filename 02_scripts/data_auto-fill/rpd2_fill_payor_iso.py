"""
Script name: rpd2_fill_payor_iso.py

Description:
This script assigns the payor ISO code for each payor country in the RPD, using data from the dataset “Countries and Economies Data.xlsx”.
...
main_iso_col = find_column_index(ws_main, "Payor country or economy (ISO)")
