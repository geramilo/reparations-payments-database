"""
Script name: rpd3_fill_payor_region.py

Description:
This script assigns the payor region for each payor country in the RPD, using data from the dataset “Countries and Economies Data.xlsx”.
...
main_region_col = find_column_index(ws_main, "Payor region")
